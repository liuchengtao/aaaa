...
public class SysMenu  extends PageBean{
	...
	private String url;//   系统url	private Integer parentId;//   父id 关联sys_menu.id	private Integer deleted;//   是否删除,0=未删除，1=已删�?	private java.sql.Timestamp createTime;//   创建时间
	...
	public String toString() {
		return "SysMenu [id=" + id + ", name=" + name + ", url=" + url
				+ ", parentId=" + parentId + ", deleted=" + deleted
				+ ", createTime=" + createTime + ", updateTime=" + updateTime
				+ ", rank=" + rank + ", actions=" + actions + ", subCount="
				+ subCount + ", btns=" + btns + "]";
	}
